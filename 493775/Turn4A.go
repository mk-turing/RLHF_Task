...
func SearchProducts(w http.ResponseWriter, r *http.Request) {
	...
	pageNumberStr := r.FormValue("pageNumber")
	...
	// Parse and validate page size and number
	...
	// Calculate start index and paginate products
...
func searchInMemoryProducts(searchTerm string, filters map[string][]string) []Product {
	products := []Product{
		...
		{ID: 6, Name: "TV", Category: "electronics", Price: 799.99, Date: "2023-06-22"},
		{ID: 7, Name: "Tablet", Category: "electronics", Price: 299.99, Date: "2023-07-01"},
		{ID: 8, Name: "Blender", Category: "appliances", Price: 199.99, Date: "2023-08-05"},
		{ID: 9, Name: "Microwave", Category: "appliances", Price: 149.99, Date: "2023-09-10"},
		{ID: 10, Name: "Camera", Category: "electronics", Price: 599.99, Date: "2023-10-15"},
	}
